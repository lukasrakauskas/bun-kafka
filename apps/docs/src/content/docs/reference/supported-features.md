...
| Group management    | Classic and KIP-848 groups, broker/range/cooperative assignment, static membership, offsets |
...
- Bun 1.4 or newer
- Apache Kafka 0.11 or newer; KIP-848 consumer groups require Kafka 4.x
- Kafka-compatible Redpanda brokers use the classic group protocol unless they expose ConsumerGroupHeartbeat v0
