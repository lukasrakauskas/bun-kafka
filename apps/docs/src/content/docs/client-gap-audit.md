...
| Finding                                                                                                           | Status here                                                                                                                                                                                                                    | Disposition                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| IncrementalAlterConfigs (append/remove single values without clobbering, Apache Kafka 2.3+)                       | ~~AlterConfigs v0 replace-mode only~~ **Fixed**: `admin.incrementalAlterConfigs()` speaks IncrementalAlterConfigs v1 flexible; verified against a live broker (set/append/subtract/delete, per-resource errors, validate-only) | Resolved in this release cycle. Requires Apache Kafka 2.3+ / current Redpanda; older brokers answer UNSUPPORTED_VERSION |
