...
| Finding                                                                                               | Status here                                                                                                                                                                | Disposition                                                                                                                                  |
| ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Next-generation consumer protocol (KIP-848, GA Kafka 4.0) — all mature clients are adopting           | **Resolved**: opt-in ConsumerGroupHeartbeat v0, broker-side assignment, topic-ID reconciliation, offset v9, and a Kafka 4.x CI matrix                                      | Classic remains the default for older brokers and migration safety; select `groupProtocol: "consumer"` per group after all members are ready |
...
0.11, PLAIN/SCRAM/OAUTHBEARER/mTLS auth). The remaining release item is the 72-hour follow-up soak before releases that touch
