...
/** Broker error codes from the Kafka wire protocol. */
export const KafkaErrorCode = {
  LOCAL_ERROR: -1,
  NONE: 0,
...
export const kafkaErrorNames = Object.fromEntries(
  Object.entries(KafkaErrorCode).map(([name, code]) => [code, name]),
