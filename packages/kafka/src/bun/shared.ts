...
const API_CONSUMER_GROUP_HEARTBEAT = 68;
const API_DESCRIBE_CONFIGS = 32;
const API_ALTER_CONFIGS = 33;
const API_INCREMENTAL_ALTER_CONFIGS = 44;
const API_ELECT_LEADERS = 43;
const API_ALTER_PARTITION_REASSIGNMENTS = 45;
const API_LIST_PARTITION_REASSIGNMENTS = 46;
...
export const CONSUMER_GROUP_HEARTBEAT_API_VERSION = 0;
export const CONSUMER_GROUP_OFFSET_API_VERSION = 9;
export const TOPIC_ID_METADATA_API_VERSION = 10;
